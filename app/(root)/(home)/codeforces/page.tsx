...
const Codeforces = () => {
  ...
  const filterProblems = useCallback(
    (submissions: Submission[]) => {
      ...
      setFilteredProblems((prevFilteredProblems) => {
        if (JSON.stringify(prevFilteredProblems) !== JSON.stringify(filtered)) {
          return filtered;
        }
        return prevFilteredProblems;
      });
      setCurrentPage(1);
    },
    [problems, selectedRating, searchQuery, selectedTags] // Dependencies
  );
  ...
  const handleClear = useCallback(() => {
    ...
    setSubmissionData([]);
    setUserInfo(null);
    filterProblems([]); // Reset the filtered problems to include all problems
  }, [filterProblems]);
  ...
  // Call filterProblems when dependencies change
  useEffect(() => {
    filterProblems(submissionData);
  }, [filterProblems, submissionData]);
...
//                 value={handle}
//                 onChange={(e) => setHandle(e.target.value)}
//                 className="p-2 w-full md:w-auto rounded border border-gray-300"
//               />
//               <button
//                 onClick={fetchSubmission}
//                 className="p-2 md:ml-2 rounded bg-blue-500 text-white hover:bg-blue-700 transition duration-500 ease-in-out"
...
//                 value={searchQuery}
//                 onChange={(e) => setSearchQuery(e.target.value)}
//                 className="p-2 md:w-72 rounded border border-gray-300 mb-2 md:mb-0"
//               />
//               <button
//                 onClick={handleSearch}
//                 className="p-2 ml-2 rounded bg-blue-500 text-white hover:bg-blue-700 transition duration-500 ease-in-out mt-2"
...
//                       {rating}
//                     </button>
//                     <div className="absolute bottom-0 left-0 w-full h-5 overflow-visible opacity-20 bg-gray-800 rounded">
//                       <div
//                         className={`h-full ${getBgColor(rating)} rounded`}
//                         style={{ width: `${progress}%`}}
//                       ></div>
//                     </div>
//                   </div>
...
//                 className={`p-2 rounded transition ${
//                   selectedRating === null
//                     ? "text-white bg-indigo-500 shadow-lg shadow-indigo-500/50 hover:bg-indigo-700 transition duration-500 ease-in-out"
//                     : "bg-gray-600 shadow-lg text-white shadow-gray-600/50 hover:bg-gray-900 transition duration-500 ease-in-out"
//                 }`}
//               >
//                 All Ratings
//               </button>
...
//                         key={tag}
//                         variant="outline"
//                         className="mr-2 mb-2 inline-block text-white"
//                       >
//                         {tag}
//                       </Badge>
//                     ))}
